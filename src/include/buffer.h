...
private:
  ...
  public:
    ...
    unsigned unused_tail_length() const noexcept;
    ...
    unsigned append(const char *p, unsigned l) noexcept;
#if __cplusplus >= 201703L
  ...
  private:
    ...
    ptr& refill_append_space(const unsigned len) noexcept;

  public:
    void microreserve(size_t) noexcept;
    // cons/des
    ...
    size_t get_append_buffer_unused_tail_length() const noexcept;
    ...
    void append(char c);
    void append(const char *data, unsigned len) noexcept;
