...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    .set_default("memtable_huge_page_size=2097152,compression=kNoCompression,max_write_buffer_number=4,min_write_buffer_number_to_merge=1,recycle_log_file_num=4,write_buffer_size=268435456,writable_file_max_buffer_size=0,compaction_readahead_size=2097152")
